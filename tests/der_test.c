...
static int der_choice_n_custom_test(void)
{
   ...
   for (x = 0; x < n * 2; x++) {
       ...
       LTC_SET_ASN1(types, y, LTC_ASN1_CUSTOM_TYPE, custom, 1);
       LTC_SET_ASN1_IDENTIFIER(types, y++, LTC_ASN1_CL_CONTEXT_SPECIFIC, LTC_ASN1_PC_CONSTRUCTED, 0);
       ...
       /* custom encode */
       child[0] = types[x % n];
       LTC_SET_ASN1(root, 0, LTC_ASN1_CUSTOM_TYPE, child, 1);
       LTC_SET_ASN1_IDENTIFIER(root, 0, LTC_ASN1_CL_CONTEXT_SPECIFIC, LTC_ASN1_PC_CONSTRUCTED, 1U << x);
